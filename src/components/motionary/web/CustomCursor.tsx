...
export const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    const checkPointer = () => {
        const target = document.querySelectorAll('button, a, input, [data-cursor="pointer"]');
        target.forEach((el) => {
    ...
    // Simple global check for hover state
    ...
    <>
      ...
      <motion.div 
        ...
        style={{
            translateX: cursorX,
            translateY: cursorY,
            x: 12, // Offset to center dot inside the bigger circle
            y: 12
        }}
      />
    </>
